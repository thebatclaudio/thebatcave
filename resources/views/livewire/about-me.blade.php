<div id="timeline" class="text-center text-white font-mono animate-fade-delay">
    ...
    <div class="mx-auto mt-32 batman">
        ...
        <div class="content relative mx-auto text-lg w-9/12 bg-zinc-800 bg-gradient-to-t from-zinc-900 from-40% py-8 mt-6 mb-10 rounded-sm">Watched <strong class="batman-returns"><span class="batman-text">Batman</span><br><span class="returns-text">Returns</span></strong> for the first time</div>
    </div>
    <div class="mx-auto mt-32 amiga">
        <div class="date text-sm mx-auto table lowercase">September 1996</div>
        <div class="content h-40 grid place-items-center relative mx-auto text-lg w-9/12 bg-zinc-800 bg-gradient-to-t from-zinc-900 from-40% py-8 mt-6 mb-10 rounded-sm">
    ...
    <div class="mx-auto mt-32 html">
        ...
        <div class="content relative mx-auto text-lg w-9/12 bg-zinc-800 bg-gradient-to-t from-zinc-900 from-40% py-8 mt-6 mb-10 rounded-sm">First <span class="code"><span class="html-code">HTML</span>&&<span class="css-code">CSS</span></span> website online</div>
    </div>
    <div class="mx-auto mt-32 graduate">
        ...
        <div class="content relative mx-auto text-lg w-9/12 bg-zinc-800 bg-gradient-to-t from-zinc-900 from-40% py-8 mt-6 mb-10 rounded-sm">
            Senior High School Degree in <span class="code"><span class="html-code">Information</span>_<span class="css-code">Technology</span></span> at ITIS A. Volta
        </div>
    </div>
